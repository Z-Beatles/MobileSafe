package cn.waynechu.mobilesafe.chapter05.adapter;
...
public class ScanVirusAdapter extends BaseAdapter {
	...
	public Object getItem(int posotion) {
		return mScanAppInfos.get(posotion);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.mScanIconImgv = (ImageView) convertView
		...
		if (!scanAppInfo.isVirus) {
			holder.mScanIconImgv
					.setBackgroundResource(R.drawable.blue_right_icon);
			holder.mAppNameTV.setTextColor(context.getResources().getColor(
					R.color.black));

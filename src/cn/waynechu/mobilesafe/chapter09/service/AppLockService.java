package cn.waynechu.mobilesafe.chapter09.service;

import java.util.List;

import cn.waynechu.mobilesafe.chapter09.EnterPswActivity;
...
public class AppLockService extends Service {
	...
	public void onCreate() {
		...
		IntentFilter filter = new IntentFilter("cn.waynechu.mobilesafe.applock");
	...
	class AppLockReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			if ("cn.waynechu.mobilesafe.applock".equals(intent.getAction())) {

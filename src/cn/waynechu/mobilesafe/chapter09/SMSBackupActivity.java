...
import cn.waynechu.mobilesafe.chapter09.utils.SmsBackUpUtils;
import cn.waynechu.mobilesafe.chapter09.utils.UIUtils;
import cn.waynechu.mobilesafe.chapter09.utils.SmsBackUpUtils.BackupStatusCallback;
import cn.waynechu.mobilesafe.chapter09.widget.MyCircleProgress;
	...
	public void onClick(View v) {
		...
		case R.id.mcp_smsbackup:
			...
			new Thread() {
				public void run() {
					try {
						boolean backUpSms = smsBackUpUtils.backUpSms(
								SMSBackupActivity.this,
								new BackupStatusCallback() {
						...
						e.printStackTrace();
						UIUtils.showToast(SMSBackupActivity.this,
								"SD卡不可用或SD卡内存不足");
					} catch (IOException e) {
						e.printStackTrace();

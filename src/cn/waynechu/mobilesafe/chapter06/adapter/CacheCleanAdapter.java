package cn.waynechu.mobilesafe.chapter06.adapter;
...
public class CacheCleanAdapter extends BaseAdapter {
	...
	public CacheCleanAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.mCacheSizeTV.setText(Formatter.formatFileSize(context, cacheInfo.cacheSiza));
		return convertView;
	}
